...
impl ScenePipeline {
    ...
    pub fn prepare(
        ...
        // SEAM-ANCHOR EXPERIMENT: the one place the drawn handover line's own
        // offset becomes a number the shader can read. After the block is
        // built, because the follow is measured against the very pose and
        // lenses the draw will use, and before the write, because that is the
        // copy the GPU sees.
        //
